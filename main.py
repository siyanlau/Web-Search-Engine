...
def parse_args(argv):
    ap = argparse.ArgumentParser(description="MiniCrawler v0.2 (single-thread BFS with robots/content gating)")
    ...
    ap.add_argument("--user-agent", default="MiniCrawler/0.2", help="User-Agent header")
